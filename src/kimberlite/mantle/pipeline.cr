...
#       property bindings : Array(Vulkan::VertexInputBindingDescription)
#       property attributes : Array(Vulkan::VertexInputAttributeDescription)
#       property viewport : Vulkan::Viewport
#       property scissor : Vulkan::Rect2D

#       def initialize(@viewport, @scissor, @attributes, @bindings)
#       end

#       def to_vulkan(pass : Vulkan::RenderPass)
...
#         viewport = Vulkan::Viewport.new(extent.width, extent.height, 0.0_f32, 0.0_f32, 0.0_f32, 1.0_f32)
